...
public class OSD_TransactionService {
    ...
    public void saveTransaction(Map<String, Object> body, User user) {
        ...
        if (body.containsKey("date")) {
            ...
            System.out.println("=== SAVE DEBUG: business_date from 'date' field ===");
            System.out.println("Date string received: " + dateStr);
            System.out.println("Parsed LocalDate: " + localDate);
            System.out.println("Stored as epoch millis: " + businessDateMillis);
        } else {
            ...
            t.setBusinessDate(businessDateMillis);
            System.out.println("=== SAVE DEBUG: business_date from current date ===");
            System.out.println("Current UTC date: " + today);
            System.out.println("Stored as epoch millis: " + businessDateMillis);
        }
