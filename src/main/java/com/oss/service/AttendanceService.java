...
public class AttendanceService {
    ...
    public Attendance checkIn(Instant manualTime) {
        ...
        att.setCheckInTime(manualTime != null ? manualTime : Instant.now()); // ✅ FIX
    ...
    public Attendance checkOut(Instant manualTime) {
        ...
        att.setCheckOutTime(manualTime != null ? manualTime : Instant.now()); // ✅ FIX
        att.setStatus("COMPLETED");
        att.setTotalMinutes(att.getWorkedMinutes());
        att.setManualCheckout(manualTime != null); // ✅ FIX
